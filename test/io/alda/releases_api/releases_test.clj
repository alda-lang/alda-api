...
(deftest latest-releases-tests
  (testing "providing data about the latest releases"
    ...
    (doseq [[from-version expected-release-versions expected-explanation]
            [[nil      ["2.1.2"]          nil]
             [[0 0 1]  ["1.99.2" "2.1.2"] releases/alda-v2-explanation]
             [[1 0 0]  ["1.99.2" "2.1.2"] releases/alda-v2-explanation]
             [[1 0 1]  ["1.99.2" "2.1.2"] releases/alda-v2-explanation]
             [[1 5 0]  ["1.99.2" "2.1.2"] releases/alda-v2-explanation]
             [[1 99 9] ["2.1.2"]          releases/alda-v2-explanation]
             [[2 0 0]  ["2.1.2"]          nil]
             [[2 0 2]  ["2.1.2"]          nil]
             [[2 1 0]  ["2.1.2"]          nil]
             [[2 1 2]  []                 nil]
